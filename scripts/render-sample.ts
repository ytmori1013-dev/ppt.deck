...
const deck: Deck = {
  ...
  slides: [
    ...
    },
    {
      ...
      kpis: [
        { value: "5,000億円", label: "2030年市場規模" },
        { value: "+22%", label: "年平均成長率(CAGR)" },
        { value: "30万基", label: "想定設置基数" },
      ],
    },
    {
      layout: "chart",
    ...
    },
    {
      ...
      bullets: [
        { text: "立地が稼働率を決定づける", sub: ["商業施設・幹線道路沿いが有利", "用地確保競争が激化"] },
        { text: "初期投資の回収には平均5〜7年を要する" },
        { text: "電力調達コストが収益を左右する" },
      ],
    },
    {
      layout: "two-column",
